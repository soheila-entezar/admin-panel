  ...
  return (
    <div className="w-[100%] h-screen flex justify-center items-center ">
      <div className="w-[95%] sm:w-[450px] h-[80%] md:h-[70%] shadow-md rounded-lg flex flex-wrap justify-center items-center my-4">
        ...
        <form className="w-[90%] sm:[80%] h-[70%]  md:h-[65%] flex flex-wrap items-center">
          ...
          <div className=" w-[100%] h-[30%] md:h-[25%]  flex flex-wrap justify-between  mt-4 md:mt-4">
            <div className="w-[100%] md:w-[50%] h-[23%] md:h-[30%]">
               <input className="" type="checkbox" />
            <label>Remember password</label>
            </div>
           <a className="w-[100%] md:w-[40%] h-[23%]">Forgot password?</a>
           <button type="submit" className="w-[100%] h-[35%] md:h-[47%] bg-[#006666] text-[#f8fafc] rounded-md font-light sm:mt-[15px]">sing in</button>
          </div>
          <div className=" w-[100%] h-[8%] md:h-[10%]  flex items-center"><h6 className="font-[bold] text-[#5b5e61]">Or Sign in with</h6></div>
